...
public class operacionesUsuarioImpl implements operacionesUsuario {
	...
	public Tarea guardaTarea(Tarea t) {
		...
		Tarea tarea = new Tarea(tareabd.getId(), tareabd.getName(), tareabd.getDescription(), tareabd.getHours(),
				tareabd.getPriority());
		return tarea;
	}
	...
	public void modificaTarea(Tarea t) {
		...
		funcionesBD.modificarTarea(modificar.getId(), t.getNombre(), t.getDescripcion(), t.getHoras(),
				t.getPrioridad());
	}
